# ============================================================
#  DJI Mavic 2 Pro – DRONE2 (Follower Behind)
# ============================================================
...
FOLLOW_DISTANCE = 2.0     # distance BEHIND leader
SPEED_GAIN = 0.30
...
while robot.step(timestep) != -1:
    ...
    print(f"[DRONE2 POS] x={fx:.2f}, y={fy:.2f}, z={fz:.2f}")

    # Formation behind leader (correct axis)
    target_x = lx
    target_z = lz + FOLLOW_DISTANCE

    dx = target_x - fx
    dz = target_z - fz

    roll_disturb  = dx * SPEED_GAIN
